...
export default function WhoWeAre() {
  return (
    <>
    <section className="bg-gray-100 bg-gradient-to-b from-gray-100 via-gray-100 to-gray-200 py-12 md:py-16 px-4 sm:px-8 md:px-12">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12 lg:gap-36 md:gap-18">
        {/* Image Section */}
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 120"><path fill="#E5E7EB" fill-opacity="1" d="M0,160L48,149.3C96,139,192,117,288,96C384,75,480,53,576,42.7C672,32,768,32,864,64C960,96,1056,160,1152,176C1248,192,1344,160,1392,144L1440,128L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z"></path></svg>
